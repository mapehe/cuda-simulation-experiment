...
void normalizePsi(cuFloatComplex *d_psi, dim3 block, dim3 grid, GaussianArgs args);

// --- Potential / Environment ---
__global__ void initComplexPotential(cuComplex *d_V_tot, PotentialArgs args);

// --- Time Evolution (Split-Step) ---
__global__ void initKineticOperator(cuFloatComplex *d_expK, KineticInitArgs args);
